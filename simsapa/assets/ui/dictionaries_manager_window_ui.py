...
class Ui_DictionariesManagerWindow(object):
    def setupUi(self, DictionariesManagerWindow):
        ...
        self.action_Copy = QtGui.QAction(DictionariesManagerWindow)
        self.action_Copy.setObjectName("action_Copy")
        self.action_Paste = QtGui.QAction(DictionariesManagerWindow)
        self.action_Paste.setObjectName("action_Paste")
        self.action_Quit = QtGui.QAction(DictionariesManagerWindow)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/close"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_Quit.setIcon(icon)
        self.action_Quit.setObjectName("action_Quit")
        self.action_Sutta_Search = QtGui.QAction(DictionariesManagerWindow)
        icon1 = QtGui.QIcon()
        ...
        self.action_Dictionary_Search = QtGui.QAction(DictionariesManagerWindow)
        icon2 = QtGui.QIcon()
        ...
        self.action_About = QtGui.QAction(DictionariesManagerWindow)
        self.action_About.setObjectName("action_About")
        self.action_Website = QtGui.QAction(DictionariesManagerWindow)
        self.action_Website.setObjectName("action_Website")
        self.action_Close_Window = QtGui.QAction(DictionariesManagerWindow)
        self.action_Close_Window.setObjectName("action_Close_Window")
        self.action_Open = QtGui.QAction(DictionariesManagerWindow)
        self.action_Open.setObjectName("action_Open")
        self.action_Document_Reader = QtGui.QAction(DictionariesManagerWindow)
        self.action_Document_Reader.setObjectName("action_Document_Reader")
        self.action_Add = QtGui.QAction(DictionariesManagerWindow)
        self.action_Add.setObjectName("action_Add")
        self.action_Remove = QtGui.QAction(DictionariesManagerWindow)
        self.action_Remove.setObjectName("action_Remove")
        self.action_Open_Selected = QtGui.QAction(DictionariesManagerWindow)
        self.action_Open_Selected.setObjectName("action_Open_Selected")
        self.action_Library = QtGui.QAction(DictionariesManagerWindow)
        self.action_Library.setObjectName("action_Library")
        self.action_Memos = QtGui.QAction(DictionariesManagerWindow)
        self.action_Memos.setObjectName("action_Memos")
        self.action_Sync_to_Anki = QtGui.QAction(DictionariesManagerWindow)
        self.action_Sync_to_Anki.setObjectName("action_Sync_to_Anki")
        self.action_Export = QtGui.QAction(DictionariesManagerWindow)
        self.action_Export.setObjectName("action_Export")
        self.action_Import_from_File = QtGui.QAction(DictionariesManagerWindow)
        self.action_Import_from_File.setObjectName("action_Import_from_File")
        self.action_Add_from_URL = QtGui.QAction(DictionariesManagerWindow)
        self.action_Add_from_URL.setObjectName("action_Add_from_URL")
        self.action_Dictionaries_Manager = QtGui.QAction(DictionariesManagerWindow)
        self.action_Dictionaries_Manager.setObjectName("action_Dictionaries_Manager")
        self.action_Check_Updates = QtGui.QAction(DictionariesManagerWindow)
        self.action_Check_Updates.setObjectName("action_Check_Updates")
        self.action_Links = QtGui.QAction(DictionariesManagerWindow)
