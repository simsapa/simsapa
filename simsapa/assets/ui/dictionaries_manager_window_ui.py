...
class Ui_DictionariesManagerWindow(object):
    def setupUi(self, DictionariesManagerWindow):
        ...
        self.central_widget = QtWidgets.QWidget(parent=DictionariesManagerWindow)
        ...
        self.dictionary_sources_list = QtWidgets.QListView(parent=self.verticalLayoutWidget_2)
        font = QtGui.QFont()
        ...
        self.dict_cover = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        self.dict_cover.setMinimumSize(QtCore.QSize(100, 0))
        font = QtGui.QFont()
        font.setPointSize(11)
        self.dict_cover.setFont(font)
        self.dict_cover.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignTop)
        self.dict_cover.setObjectName("dict_cover")
        self.info_layout.addWidget(self.dict_cover)
        self.dict_title = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.dict_title.setFont(font)
        self.dict_title.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignTop)
        self.dict_title.setObjectName("dict_title")
        self.info_layout.addWidget(self.dict_title)
        self.dict_creator = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.dict_creator.setFont(font)
        self.dict_creator.setAlignment(QtCore.Qt.AlignmentFlag.AlignLeading|QtCore.Qt.AlignmentFlag.AlignLeft|QtCore.Qt.AlignmentFlag.AlignTop)
        self.dict_creator.setObjectName("dict_creator")
        self.info_layout.addWidget(self.dict_creator)
        self.dict_version = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setPointSize(11)
        self.dict_version.setFont(font)
        self.dict_version.setObjectName("dict_version")
        self.info_layout.addWidget(self.dict_version)
        self.dict_description = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setPointSize(9)
        ...
        self.dict_message = QtWidgets.QLabel(parent=self.verticalLayoutWidget_3)
        font = QtGui.QFont()
        font.setPointSize(9)
        self.dict_message.setFont(font)
        self.dict_message.setObjectName("dict_message")
        self.info_layout.addWidget(self.dict_message)
        self.dict_update_button = QtWidgets.QPushButton(parent=self.verticalLayoutWidget_3)
        ...
        self.menubar = QtWidgets.QMenuBar(parent=DictionariesManagerWindow)
        ...
        self.toolBar = QtWidgets.QToolBar(parent=DictionariesManagerWindow)
        self.toolBar.setObjectName("toolBar")
        DictionariesManagerWindow.addToolBar(QtCore.Qt.ToolBarArea.LeftToolBarArea, self.toolBar)
        self.toolBar_2 = QtWidgets.QToolBar(parent=DictionariesManagerWindow)
        self.toolBar_2.setObjectName("toolBar_2")
        DictionariesManagerWindow.addToolBar(QtCore.Qt.ToolBarArea.TopToolBarArea, self.toolBar_2)
        self.action_Copy = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Copy.setObjectName("action_Copy")
        self.action_Paste = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Paste.setObjectName("action_Paste")
        self.action_Quit = QtGui.QAction(parent=DictionariesManagerWindow)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/close"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_Quit.setIcon(icon)
        self.action_Quit.setObjectName("action_Quit")
        self.action_Sutta_Search = QtGui.QAction(parent=DictionariesManagerWindow)
        icon1 = QtGui.QIcon()
        ...
        self.action_Dictionary_Search = QtGui.QAction(parent=DictionariesManagerWindow)
        icon2 = QtGui.QIcon()
        ...
        self.action_About = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_About.setObjectName("action_About")
        self.action_Website = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Website.setObjectName("action_Website")
        self.action_Close_Window = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Close_Window.setObjectName("action_Close_Window")
        self.action_Open = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Open.setObjectName("action_Open")
        self.action_Document_Reader = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Document_Reader.setObjectName("action_Document_Reader")
        self.action_Add = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Add.setObjectName("action_Add")
        self.action_Remove = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Remove.setObjectName("action_Remove")
        self.action_Open_Selected = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Open_Selected.setObjectName("action_Open_Selected")
        self.action_Library = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Library.setObjectName("action_Library")
        self.action_Memos = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Memos.setObjectName("action_Memos")
        self.action_Sync_to_Anki = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Sync_to_Anki.setObjectName("action_Sync_to_Anki")
        self.action_Export = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Export.setObjectName("action_Export")
        self.action_Import_from_File = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Import_from_File.setObjectName("action_Import_from_File")
        self.action_Add_from_URL = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Add_from_URL.setObjectName("action_Add_from_URL")
        self.action_Dictionaries_Manager = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Dictionaries_Manager.setObjectName("action_Dictionaries_Manager")
        self.action_Check_Updates = QtGui.QAction(parent=DictionariesManagerWindow)
        self.action_Check_Updates.setObjectName("action_Check_Updates")
        self.action_Links = QtGui.QAction(parent=DictionariesManagerWindow)
    ...
    def retranslateUi(self, DictionariesManagerWindow):
        ...
        self.action_Memos.setText(_translate("DictionariesManagerWindow", "&Memos"))
        self.action_Memos.setToolTip(_translate("DictionariesManagerWindow", "Memos"))
        self.action_Memos.setShortcut(_translate("DictionariesManagerWindow", "F9"))
