...
class Ui_DictionarySearchWindow(object):
    def setupUi(self, DictionarySearchWindow):
        ...
        self.rightside_tabs.addTab(self.history_tab, "")
    ...
    def retranslateUi(self, DictionarySearchWindow):
        ...
        self.rightside_tabs.setTabText(self.rightside_tabs.indexOf(self.history_tab), _translate("DictionarySearchWindow", "History"))
