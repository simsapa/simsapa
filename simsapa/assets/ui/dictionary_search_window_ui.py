...
class Ui_DictionarySearchWindow(object):
    def setupUi(self, DictionarySearchWindow):
        ...
        self.open_selected_link_button.setIcon(icon)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/book"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.action_Sutta_Search.setIcon(icon9)
