...
class Ui_DictionarySearchWindow(object):
    ...
    def retranslateUi(self, DictionarySearchWindow):
        ...
        self.fulltext_prev_btn.setText(_translate("DictionarySearchWindow", "Prev"))
        self.fulltext_next_btn.setText(_translate("DictionarySearchWindow", "Next"))
        self.fulltext_label.setText(_translate("DictionarySearchWindow", "Showing a-b out of x"))
        self.fulltext_first_page_btn.setText(_translate("DictionarySearchWindow", "First"))
        self.fulltext_last_page_btn.setText(_translate("DictionarySearchWindow", "Last"))
