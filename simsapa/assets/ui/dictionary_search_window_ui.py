...
class Ui_DictionarySearchWindow(object):
    def setupUi(self, DictionarySearchWindow):
        ...
        self.action_Cards = QtWidgets.QAction(DictionarySearchWindow)
    ...
    def retranslateUi(self, DictionarySearchWindow):
        ...
        self.action_Cards.setText(_translate("DictionarySearchWindow", "&Cards"))
        self.action_Cards.setToolTip(_translate("DictionarySearchWindow", "Cards"))
        self.action_Cards.setShortcut(_translate("DictionarySearchWindow", "F9"))
