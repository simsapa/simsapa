...
class Ui_DictionarySearchWindow(object):
    def setupUi(self, DictionarySearchWindow):
        ...
        self.action_Close = QtWidgets.QAction(DictionarySearchWindow)
    ...
    def retranslateUi(self, DictionarySearchWindow):
        ...
        self.menuWindows.setTitle(_translate("DictionarySearchWindow", "Windows"))
        ...
        self.action_Close.setText(_translate("DictionarySearchWindow", "&Close"))
