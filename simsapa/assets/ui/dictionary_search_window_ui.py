...
class Ui_DictionarySearchWindow(object):
    def setupUi(self, DictionarySearchWindow):
        ...
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/angle-left"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon4 = QtGui.QIcon()
        icon4.addPixmap(QtGui.QPixmap(":/angle-right"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon5 = QtGui.QIcon()
        icon5.addPixmap(QtGui.QPixmap(":/angles-left"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/angles-right"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        self.rightside_tabs.addTab(self.fulltext_tab, icon2, "")
        ...
        icon7 = QtGui.QIcon()
        icon7.addPixmap(QtGui.QPixmap(":/reload"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon8 = QtGui.QIcon()
        icon8.addPixmap(QtGui.QPixmap(":/book"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/diagram"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.rightside_tabs.addTab(self.links_tab, icon9, "")
        ...
        icon10 = QtGui.QIcon()
        icon10.addPixmap(QtGui.QPixmap(":/pen-fancy"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.rightside_tabs.addTab(self.memos_tab, icon10, "")
        ...
        icon11 = QtGui.QIcon()
        icon11.addPixmap(QtGui.QPixmap(":/history-icon"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.rightside_tabs.addTab(self.recent_tab, icon11, "")
        ...
        icon12 = QtGui.QIcon()
        icon12.addPixmap(QtGui.QPixmap(":/close"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        ...
        icon13 = QtGui.QIcon()
        icon13.addPixmap(QtGui.QPixmap(":/dictionary"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_Dictionary_Search.setIcon(icon13)
        ...
        self.action_Links.setIcon(icon9)
        ...
        self.action_Incremental_Search = QtGui.QAction(DictionarySearchWindow)
        self.action_Incremental_Search.setCheckable(True)
        self.action_Incremental_Search.setChecked(True)
        self.action_Incremental_Search.setStatusTip("")
        self.action_Incremental_Search.setObjectName("action_Incremental_Search")
        ...
        self.menu_Go.addAction(self.action_Incremental_Search)
    ...
    def retranslateUi(self, DictionarySearchWindow):
        ...
        self.action_Incremental_Search.setText(_translate("DictionarySearchWindow", "&Incremental Search"))
        self.action_Incremental_Search.setToolTip(_translate("DictionarySearchWindow", "Run search query immediately when stopped typing"))
