...
class Ui_DictionarySearchWindow(object):
    def setupUi(self, DictionarySearchWindow):
        ...
        self.deconstructor_frame.setObjectName("deconstructor_frame")
        self.verticalLayout_4.addWidget(self.deconstructor_frame)
        ...
        self.action_Notify_About_Simsapa_Updates = QtGui.QAction(parent=DictionarySearchWindow)
        ...
        self.action_Notify_About_DPD_Updates = QtGui.QAction(parent=DictionarySearchWindow)
        ...
        self.action_Show_Word_Lookup = QtGui.QAction(parent=DictionarySearchWindow)
        ...
        self.action_Show_Search_Bar = QtGui.QAction(parent=DictionarySearchWindow)
        ...
        self.action_Show_Search_Options = QtGui.QAction(parent=DictionarySearchWindow)
        ...
        self.action_Check_for_Simsapa_Updates = QtGui.QAction(parent=DictionarySearchWindow)
        self.action_Check_for_Simsapa_Updates.setObjectName("action_Check_for_Simsapa_Updates")
        self.action_Check_for_DPD_Updates = QtGui.QAction(parent=DictionarySearchWindow)
        ...
        self.action_Keep_Running_in_the_Background = QtGui.QAction(parent=DictionarySearchWindow)
        ...
        self.action_Start_in_Low_Memory_Mode = QtGui.QAction(parent=DictionarySearchWindow)
        ...
        self.action_Tray_Click_Opens_Window = QtGui.QAction(parent=DictionarySearchWindow)
    ...
    def retranslateUi(self, DictionarySearchWindow):
        ...
        self.action_Notify_About_Simsapa_Updates.setText(_translate("DictionarySearchWindow", "Notify About Simsapa Updates"))
        self.action_Notify_About_DPD_Updates.setText(_translate("DictionarySearchWindow", "Notify About DPD Updates"))
        ...
        self.action_Show_Word_Lookup.setText(_translate("DictionarySearchWindow", "Show Word Lookup"))
        self.action_Show_Word_Lookup.setShortcut(_translate("DictionarySearchWindow", "Ctrl+F6"))
        ...
        self.action_Show_Search_Bar.setText(_translate("DictionarySearchWindow", "Show Search &Bar"))
        self.action_Show_Search_Bar.setShortcut(_translate("DictionarySearchWindow", "Ctrl+Shift+/"))
        self.action_Show_Search_Bar.setToolTip(_translate("DictionarySearchWindow", "Show or hide the search bar with input field and controls"))
        self.action_Show_Search_Options.setText(_translate("DictionarySearchWindow", "Show Search Options"))
        self.action_Show_Search_Options.setToolTip(_translate("DictionarySearchWindow", "Show or the search control options"))
        ...
        self.action_Check_for_Simsapa_Updates.setText(_translate("DictionarySearchWindow", "Check for Simsapa Updates..."))
        self.action_Check_for_DPD_Updates.setText(_translate("DictionarySearchWindow", "Check for DPD Updates..."))
        ...
        self.action_Keep_Running_in_the_Background.setText(_translate("DictionarySearchWindow", "Keep Running in the Background"))
        self.action_Start_in_Low_Memory_Mode.setText(_translate("DictionarySearchWindow", "Start in Low Memory Mode"))
        self.action_Tray_Click_Opens_Window.setText(_translate("DictionarySearchWindow", "Tray Click Opens Window..."))
