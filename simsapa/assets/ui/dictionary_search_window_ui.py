...
class Ui_DictionarySearchWindow(object):
    def setupUi(self, DictionarySearchWindow):
        ...
        self.memos_list = QtWidgets.QListWidget(self.memos_tab)
        self.memos_list.setFrameShape(QtWidgets.QFrame.NoFrame)
        ...
        self.tabWidget.addTab(self.memos_tab, "")
        ...
        self.verticalLayout_3.addLayout(self.history_layout)
        ...
        self.toolBar_2 = QtWidgets.QToolBar(DictionarySearchWindow)
        self.toolBar_2.setObjectName("toolBar_2")
        DictionarySearchWindow.addToolBar(QtCore.Qt.TopToolBarArea, self.toolBar_2)
        ...
        self.action_Edit_Word = QtWidgets.QAction(DictionarySearchWindow)
        self.action_Edit_Word.setObjectName("action_Edit_Word")
        ...
        self.toolBar_2.addAction(self.action_Edit_Word)
    ...
    def retranslateUi(self, DictionarySearchWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.results_tab), _translate("DictionarySearchWindow", "Results"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.links_tab), _translate("DictionarySearchWindow", "Links"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.memos_tab), _translate("DictionarySearchWindow", "Memos"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.history_tab), _translate("DictionarySearchWindow", "History"))
        ...
        self.toolBar_2.setWindowTitle(_translate("DictionarySearchWindow", "toolBar_2"))
        ...
        self.action_Edit_Word.setText(_translate("DictionarySearchWindow", "&Edit Word..."))
