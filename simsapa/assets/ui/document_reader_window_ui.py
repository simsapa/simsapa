...
class Ui_DocumentReaderWindow(object):
    def setupUi(self, DocumentReaderWindow):
        ...
        self.cards_layout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.cards_layout.setContentsMargins(0, 0, 0, 0)
        self.cards_layout.setObjectName("cards_layout")
        self.horizontalLayout = QtWidgets.QHBoxLayout()
        self.horizontalLayout.setObjectName("horizontalLayout")
        self.add_card_button = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.add_card_button.setObjectName("add_card_button")
        self.horizontalLayout.addWidget(self.add_card_button)
        self.remove_card_button = QtWidgets.QPushButton(self.verticalLayoutWidget)
        self.remove_card_button.setObjectName("remove_card_button")
        self.horizontalLayout.addWidget(self.remove_card_button)
        self.cards_layout.addLayout(self.horizontalLayout)
        self.label_2 = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.label_2.setObjectName("label_2")
        self.cards_layout.addWidget(self.label_2)
        ...
        self.cards_layout.addWidget(self.front_input)
        self.label_5 = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.label_5.setObjectName("label_5")
        self.cards_layout.addWidget(self.label_5)
        ...
        self.cards_layout.addWidget(self.back_input)
        self.label_3 = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.label_3.setObjectName("label_3")
        self.cards_layout.addWidget(self.label_3)
        self.cards_list = QtWidgets.QListView(self.verticalLayoutWidget)
        self.cards_list.setObjectName("cards_list")
        self.cards_layout.addWidget(self.cards_list)
        ...
        self.action_Cards = QtWidgets.QAction(DocumentReaderWindow)
    ...
    def retranslateUi(self, DocumentReaderWindow):
        ...
        self.add_card_button.setText(_translate("DocumentReaderWindow", "Add"))
        self.remove_card_button.setText(_translate("DocumentReaderWindow", "Remove"))
        self.label_2.setText(_translate("DocumentReaderWindow", "Front"))
        self.label_5.setText(_translate("DocumentReaderWindow", "Back"))
        self.label_3.setText(_translate("DocumentReaderWindow", "Cards for this page"))
        ...
        self.action_Cards.setText(_translate("DocumentReaderWindow", "&Cards"))
        self.action_Cards.setToolTip(_translate("DocumentReaderWindow", "Cards"))
        self.action_Cards.setShortcut(_translate("DocumentReaderWindow", "F9"))
