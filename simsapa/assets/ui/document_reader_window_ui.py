...
class Ui_DocumentReaderWindow(object):
    def setupUi(self, DocumentReaderWindow):
        ...
        self.lookup_layout = QtWidgets.QVBoxLayout(self.verticalLayoutWidget)
        self.lookup_layout.setContentsMargins(0, 0, 0, 0)
        self.lookup_layout.setObjectName("lookup_layout")
        self.label_2 = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.label_2.setObjectName("label_2")
        self.lookup_layout.addWidget(self.label_2)
        self.lookup_html = QtWidgets.QTextBrowser(self.verticalLayoutWidget)
        self.lookup_html.setObjectName("lookup_html")
        self.lookup_layout.addWidget(self.lookup_html)
        self.label_3 = QtWidgets.QLabel(self.verticalLayoutWidget)
        self.label_3.setObjectName("label_3")
        self.lookup_layout.addWidget(self.label_3)
        self.history_list = QtWidgets.QListWidget(self.verticalLayoutWidget)
        self.history_list.setObjectName("history_list")
        self.lookup_layout.addWidget(self.history_list)
    ...
    def retranslateUi(self, DocumentReaderWindow):
        ...
        self.label_2.setText(_translate("DocumentReaderWindow", "Lookup"))
        self.label_3.setText(_translate("DocumentReaderWindow", "History"))
