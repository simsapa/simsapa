...
class Ui_DocumentReaderWindow(object):
    def setupUi(self, DocumentReaderWindow):
        ...
        self.rightside_tabs = QtWidgets.QTabWidget(self.verticalLayoutWidget)
        ...
        self.action_Copy = QtGui.QAction(DocumentReaderWindow)
        self.action_Copy.setObjectName("action_Copy")
        self.action_Paste = QtGui.QAction(DocumentReaderWindow)
        self.action_Paste.setObjectName("action_Paste")
        self.action_Quit = QtGui.QAction(DocumentReaderWindow)
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap(":/close"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_Quit.setIcon(icon)
        self.action_Quit.setObjectName("action_Quit")
        self.action_Sutta_Search = QtGui.QAction(DocumentReaderWindow)
        icon1 = QtGui.QIcon()
        ...
        self.action_Dictionary_Search = QtGui.QAction(DocumentReaderWindow)
        icon2 = QtGui.QIcon()
        ...
        self.action_About = QtGui.QAction(DocumentReaderWindow)
        self.action_About.setObjectName("action_About")
        self.action_Website = QtGui.QAction(DocumentReaderWindow)
        self.action_Website.setObjectName("action_Website")
        self.action_Close_Window = QtGui.QAction(DocumentReaderWindow)
        self.action_Close_Window.setObjectName("action_Close_Window")
        self.action_Document_Reader = QtGui.QAction(DocumentReaderWindow)
        self.action_Document_Reader.setObjectName("action_Document_Reader")
        self.action_Open = QtGui.QAction(DocumentReaderWindow)
        self.action_Open.setObjectName("action_Open")
        self.action_Next_Page = QtGui.QAction(DocumentReaderWindow)
        self.action_Next_Page.setObjectName("action_Next_Page")
        self.action_Previous_Page = QtGui.QAction(DocumentReaderWindow)
        self.action_Previous_Page.setObjectName("action_Previous_Page")
        self.action_Go_to_Page = QtGui.QAction(DocumentReaderWindow)
        self.action_Go_to_Page.setObjectName("action_Go_to_Page")
        self.action_Beginning = QtGui.QAction(DocumentReaderWindow)
        self.action_Beginning.setObjectName("action_Beginning")
        self.action_End = QtGui.QAction(DocumentReaderWindow)
        self.action_End.setObjectName("action_End")
        self.action_Library = QtGui.QAction(DocumentReaderWindow)
        self.action_Library.setObjectName("action_Library")
        self.action_Memos = QtGui.QAction(DocumentReaderWindow)
        self.action_Memos.setObjectName("action_Memos")
        self.action_Dictionaries_Manager = QtGui.QAction(DocumentReaderWindow)
        self.action_Dictionaries_Manager.setObjectName("action_Dictionaries_Manager")
        self.action_Zoom_Out = QtGui.QAction(DocumentReaderWindow)
        self.action_Zoom_Out.setObjectName("action_Zoom_Out")
        self.action_Zoom_In = QtGui.QAction(DocumentReaderWindow)
        self.action_Zoom_In.setObjectName("action_Zoom_In")
        self.action_Links = QtGui.QAction(DocumentReaderWindow)
