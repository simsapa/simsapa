...
class Ui_SuttaSearchWindow(object):
    ...
    def retranslateUi(self, SuttaSearchWindow):
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.results_tab), _translate("SuttaSearchWindow", "Results"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.links_tab), _translate("SuttaSearchWindow", "Links"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.memos_tab), _translate("SuttaSearchWindow", "Memos"))
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.history_tab), _translate("SuttaSearchWindow", "History"))
