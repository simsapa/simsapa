...
class Ui_SuttaSearchWindow(object):
    ...
    def retranslateUi(self, SuttaSearchWindow):
        ...
        self.fulltext_prev_btn.setText(_translate("SuttaSearchWindow", "Prev"))
        self.fulltext_next_btn.setText(_translate("SuttaSearchWindow", "Next"))
        self.fulltext_label.setText(_translate("SuttaSearchWindow", "Showing a-b out of x"))
        self.fulltext_first_page_btn.setText(_translate("SuttaSearchWindow", "First"))
        self.fulltext_last_page_btn.setText(_translate("SuttaSearchWindow", "Last"))
