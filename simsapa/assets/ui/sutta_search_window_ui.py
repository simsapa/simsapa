...
class Ui_SuttaSearchWindow(object):
    def setupUi(self, SuttaSearchWindow):
        ...
        self.action_Cards = QtWidgets.QAction(SuttaSearchWindow)
    ...
    def retranslateUi(self, SuttaSearchWindow):
        ...
        self.action_Cards.setText(_translate("SuttaSearchWindow", "&Cards"))
        self.action_Cards.setToolTip(_translate("SuttaSearchWindow", "Cards"))
        self.action_Cards.setShortcut(_translate("SuttaSearchWindow", "F9"))
