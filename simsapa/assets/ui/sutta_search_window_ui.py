...
class Ui_SuttaSearchWindow(object):
    def setupUi(self, SuttaSearchWindow):
        ...
        self.action_Incremental_Search = QtGui.QAction(SuttaSearchWindow)
    ...
    def retranslateUi(self, SuttaSearchWindow):
        ...
        self.action_Incremental_Search.setText(_translate("SuttaSearchWindow", "&Incremental Search"))
        self.action_Incremental_Search.setToolTip(_translate("SuttaSearchWindow", "Run search query immediately when stopped typing"))
