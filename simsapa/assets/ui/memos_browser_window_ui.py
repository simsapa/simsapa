...
class Ui_MemosBrowserWindow(object):
    def setupUi(self, MemosBrowserWindow):
        ...
        self.action_Start_in_Low_Memory_Mode = QtGui.QAction(parent=MemosBrowserWindow)
    ...
    def retranslateUi(self, MemosBrowserWindow):
        ...
        self.action_Start_in_Low_Memory_Mode.setText(_translate("MemosBrowserWindow", "Start in Low Memory Mode"))
