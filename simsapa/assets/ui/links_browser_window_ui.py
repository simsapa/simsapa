...
class Ui_LinksBrowserWindow(object):
    def setupUi(self, LinksBrowserWindow):
        ...
        self.action_Copy = QtGui.QAction(LinksBrowserWindow)
        self.action_Copy.setObjectName("action_Copy")
        self.action_Paste = QtGui.QAction(LinksBrowserWindow)
        self.action_Paste.setObjectName("action_Paste")
        self.action_Quit = QtGui.QAction(LinksBrowserWindow)
        icon3 = QtGui.QIcon()
        icon3.addPixmap(QtGui.QPixmap(":/close"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
        self.action_Quit.setIcon(icon3)
        self.action_Quit.setObjectName("action_Quit")
        self.action_Sutta_Search = QtGui.QAction(LinksBrowserWindow)
        self.action_Sutta_Search.setIcon(icon1)
        self.action_Sutta_Search.setObjectName("action_Sutta_Search")
        self.action_Dictionary_Search = QtGui.QAction(LinksBrowserWindow)
        icon4 = QtGui.QIcon()
        ...
        self.action_About = QtGui.QAction(LinksBrowserWindow)
        self.action_About.setObjectName("action_About")
        self.action_Website = QtGui.QAction(LinksBrowserWindow)
        self.action_Website.setObjectName("action_Website")
        self.action_Close_Window = QtGui.QAction(LinksBrowserWindow)
        self.action_Close_Window.setObjectName("action_Close_Window")
        self.action_Open = QtGui.QAction(LinksBrowserWindow)
        self.action_Open.setObjectName("action_Open")
        self.action_Document_Reader = QtGui.QAction(LinksBrowserWindow)
        self.action_Document_Reader.setObjectName("action_Document_Reader")
        self.action_Library = QtGui.QAction(LinksBrowserWindow)
        self.action_Library.setObjectName("action_Library")
        self.action_Memos = QtGui.QAction(LinksBrowserWindow)
        icon5 = QtGui.QIcon()
        ...
        self.action_Dictionaries_Manager = QtGui.QAction(LinksBrowserWindow)
        self.action_Dictionaries_Manager.setObjectName("action_Dictionaries_Manager")
        self.action_Links = QtGui.QAction(LinksBrowserWindow)
        icon6 = QtGui.QIcon()
        ...
        self.action_Re_index_database = QtGui.QAction(LinksBrowserWindow)
        self.action_Re_index_database.setObjectName("action_Re_index_database")
        self.action_Re_download_database = QtGui.QAction(LinksBrowserWindow)
        self.action_Re_download_database.setObjectName("action_Re_download_database")
        self.action_Notify_About_Updates = QtGui.QAction(LinksBrowserWindow)
        ...
        self.action_Show_Toolbar = QtGui.QAction(LinksBrowserWindow)
        self.action_Show_Toolbar.setCheckable(True)
        self.action_Show_Toolbar.setObjectName("action_Show_Toolbar")
        self.action_First_Window_on_Startup = QtGui.QAction(LinksBrowserWindow)
        self.action_First_Window_on_Startup.setObjectName("action_First_Window_on_Startup")
        self.action_Focus_Search_Input = QtGui.QAction(LinksBrowserWindow)
        self.action_Focus_Search_Input.setObjectName("action_Focus_Search_Input")
        self.action_Show_Word_Scan_Popup = QtGui.QAction(LinksBrowserWindow)
        ...
        self.action_Next_Result = QtGui.QAction(LinksBrowserWindow)
        self.action_Next_Result.setObjectName("action_Next_Result")
        self.action_Previous_Result = QtGui.QAction(LinksBrowserWindow)
        self.action_Previous_Result.setObjectName("action_Previous_Result")
        self.action_Sutta_Study = QtGui.QAction(LinksBrowserWindow)
        self.action_Sutta_Study.setIcon(icon1)
        self.action_Sutta_Study.setObjectName("action_Sutta_Study")
        self.action_Bookmarks = QtGui.QAction(LinksBrowserWindow)
        icon7 = QtGui.QIcon()
        ...
        self.action_Pali_Courses = QtGui.QAction(LinksBrowserWindow)
        self.action_Pali_Courses.setIcon(icon1)
        self.action_Pali_Courses.setObjectName("action_Pali_Courses")
        self.action_Link_Preview = QtGui.QAction(LinksBrowserWindow)
